    ...
    <div class="container py-5 mt-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-5">
            <div class="mb-3 mb-md-0">
                <h1 class="h2 fw-bold text-secondary mb-1" style="font-family: 'Outfit', sans-serif;">Normal Transactions
                </h1>
                <p class="text-muted mb-0">Track your regular income and expenses</p>
            </div>
            <div class="d-flex gap-2">
                ...
                <button type="button" class="btn btn-primary-custom shadow-sm" data-bs-toggle="modal"
                    data-bs-target="#addNormalTransaction">
                        ...
                        @forelse($transactions as $transaction)
                            <tr class="group-row">
                                ...
                                <td class="pe-4 py-3 text-end">
                                    ...
                                    <button type="button"
                                        class="btn btn-sm btn-outline-secondary border shadow-sm rounded-pill px-3 me-1"
                                        data-bs-toggle="modal" data-bs-target="#transferNormalToDraft{{ $transaction->id }}">
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h5 class="text-secondary fw-bold">No Transactions Found</h5>
