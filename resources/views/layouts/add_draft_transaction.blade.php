        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 12px;">
            ...
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold text-secondary" id="staticBackdropLabel"
                    ...
                    <i class="bi bi-file-earmark me-2 text-primary-custom"></i>
                    {{ isset($transaction) ? 'Edit Draft' : 'New Draft' }}
                </h5>
                ...
                <div class="modal-body px-4 pt-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control-custom border-start-0" name="price"
                                    ...
                                    value="{{ isset($transaction) ? $transaction->price : '' }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select select2-wallet"
                                style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 0.5rem 1rem;"
                                name="wallet_id">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select select2-month-year"
                                style="border: 1px solid #e2e8f0; border-radius: 8px; padding: 0.5rem 1rem;"
                                name="month_year_id">
