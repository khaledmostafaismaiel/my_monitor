...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet"  href= "stylesheets/css/test.css"  media="screen and (min-width:300px)" > 

        <link rel="shortcut icon" type="image/png" href="../href=stylesheets/images/favicon.png">
