                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card-custom p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="fw-bold mb-1">Join My Monitor</h2>
                            <p class="text-muted">Create an account to start tracking</p>
                        </div>

                        <!-- Toggle Buttons -->
                        <div class="d-flex bg-light rounded p-1 mb-4" id="formToggleButtons">
                            <button type="button" class="btn w-50 fw-medium text-muted" id="showSignInForm">Sign In</button>
                            <button type="button" class="btn w-50 fw-medium shadow-sm bg-white text-primary-custom"
                                id="showSignUpForm">Sign Up</button>
                        </div>
                        ...
                        <!-- Sign Up Form -->
                        <form method="POST" action="/users/sign_up" id="signUpForm">
                            {{ csrf_field() }}
